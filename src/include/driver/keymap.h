/*
 * file:		include/driver/keymap.h
 * auther:		Jason Hu
 * time:		2019/8/19
 * copyright:	(C) 2018-2019 by Book OS developers. All rights reserved.
 */

#ifndef _DRIVER_CHAR_KEYMAP_H
#define _DRIVER_CHAR_KEYMAP_H
...
PRIVATE unsigned int keymap[NR_SCAN_CODES * MAP_COLS] = {

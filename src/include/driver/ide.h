...
/* IOCTL 命令*/
#define ATA_IO_LBA_MODE		1	/* 设置寻址方式 */
#define ATA_IO_IDENTIFY		2	/* 获取磁盘信息 */
#define ATA_IO_SECTORS		3	/* 获取磁盘扇区数 */

/* IOCTL 参数 */
#define DISK_LBA_48		1	/* 设置寻址LBA48方式 */
#define DISK_LBA_24		0	/* 设置寻址LBA48方式 */

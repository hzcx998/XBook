/*
 * file:		include/kgc/controls/widget.h
 * auther:		Jason Hu
 * time:		2020/2/21
...
/* 窗口控件之标签 */
#ifndef _KGC_CONTROLS_WIDGET_H
#define _KGC_CONTROLS_WIDGET_H
...
STATIC INLINE void KGC_WidgetEven(KGC_Widget_t *widget)
{
    /* 调用事件 */
    /*if (widget->even)
        widget->even(widget);*/

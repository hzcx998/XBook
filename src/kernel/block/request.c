...
PUBLIC void MakeRequest(int major, int rw, struct BufferHead *bh)
{
    ...
    /* 请求的lba是对于磁盘设备的，而bh的lba是对于文件系统的
    文件系统的最小单位是块，而磁盘设备的最小单位是扇区
     */
    req->lba = bh->lba * req->count;
    req->errors = 0;
    req->bh = bh;

...
#include <graph/even.h>
#include <graph/button.h>
#include <graph/input.h>
#include <graph/handler.h>
#include <graph/video.h>
...
/**
 * InitUpperKGC - 初始化图形系统的上半部分
 * 
 */
PRIVATE int InitUpperKGC()
{
    /* 设置this指针指向系统数据 */
    this = &kgcPrivate;
...
/**
 * InitBottomKGC - 初始化图形系统的下半部分
 * 
 */
PRIVATE int InitBottomKGC()
{
